...
This project analyzes how different basketball performance metrics relate to overall offensive and defensive efficiency across NBA teams. Using 2024–2025 regular season team statistics, we explore which factors are most strongly associated with efficient scoring and preventing opponents from scoring. Preliminary visualizations suggest that shooting efficiency (eFG%) and field goal percentage are key drivers of offensive performance, while defensive rebounding and steals are most closely linked to defensive success. Additional analysis will be conducted to determine how these efficiencies relate to winning more games.
